...
content_type_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.content_type,
    categories=[
        # Primary Sources
...
document_category_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.content_type,  # Maps to same field
    categories=[
...
document_purpose_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.content_type,  # Maps to content type
    categories=[
