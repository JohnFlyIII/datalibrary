...
authority_level_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.authority_level,
    categories=[
...
target_audience_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.target_audience,
    categories=[
...
complexity_level_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.complexity_level,
    categories=[
...
coverage_scope_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.coverage_scope,
    categories=[
...
update_priority_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.update_priority,
    categories=[
...
human_reviewed_space = sl.CategoricalSimilaritySpace(
    category_input=legal_document.human_reviewed,
    categories=[
