...
# Convert queries to REST queries for API endpoints
discovery_rest_query = sl.RestQuery(sl.RestDescriptor("discovery"), discovery_query)
exploration_rest_query = sl.RestQuery(sl.RestDescriptor("exploration"), exploration_query)
deep_dive_rest_query = sl.RestQuery(sl.RestDescriptor("deep_dive"), deep_dive_query)
hierarchical_jurisdiction_rest_query = sl.RestQuery(sl.RestDescriptor("hierarchical_jurisdiction"), hierarchical_jurisdiction_query)
hierarchical_practice_rest_query = sl.RestQuery(sl.RestDescriptor("hierarchical_practice"), hierarchical_practice_query)
texas_employment_rest_query = sl.RestQuery(sl.RestDescriptor("texas_employment"), texas_employment_query)
fact_research_rest_query = sl.RestQuery(sl.RestDescriptor("fact_research"), fact_research_query)
executive_briefing_rest_query = sl.RestQuery(sl.RestDescriptor("executive_briefing"), executive_briefing_query)
client_communication_rest_query = sl.RestQuery(sl.RestDescriptor("client_communication"), client_communication_query)
compliance_rest_query = sl.RestQuery(sl.RestDescriptor("compliance"), compliance_query)
legal_research_rest_query = sl.RestQuery(sl.RestDescriptor("legal_research"), legal_research_query)
time_sensitive_rest_query = sl.RestQuery(sl.RestDescriptor("time_sensitive"), time_sensitive_compliance_query)
passage_rest_query = sl.RestQuery(sl.RestDescriptor("passage"), passage_query)

# Create the REST Executor
executor = sl.RestExecutor(
    sources=[legal_document_source],
    indices=[legal_knowledge_index],
    queries=[
        discovery_rest_query,
        exploration_rest_query,
        deep_dive_rest_query,
        hierarchical_jurisdiction_rest_query,
        hierarchical_practice_rest_query,
        texas_employment_rest_query,
        fact_research_rest_query,
        executive_briefing_rest_query,
        client_communication_rest_query,
        compliance_rest_query,
        legal_research_rest_query,
        time_sensitive_rest_query,
        passage_rest_query
    ],
...
if __name__ == "__main__":
    ...
    print(f"Vector DB URL: {os.getenv('QDRANT_URL', 'http://qdrant:6333')}")
