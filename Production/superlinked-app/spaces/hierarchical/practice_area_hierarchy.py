...
primary_practice_space = sl.CategoricalSimilaritySpace(
    category_list=legal_document.practice_area_primary,
    categories=[
...
secondary_practice_space = sl.CategoricalSimilaritySpace(
    category_list=legal_document.practice_area_secondary,
    categories=[
...
specific_practice_space = sl.CategoricalSimilaritySpace(
    category_list=legal_document.practice_area_specific,
    categories=[
